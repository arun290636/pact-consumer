...
public class ProviderPactTests {
    ...
    public void createPerson() throws JsonProcessingException {
        ...
        Person person = Person.builder().name("Roger Antonsen").ssn("71039012349").build();
        ...
        RequestResponsePact pact = ConsumerPactBuilder
                ...
                .willRespondWith()
                    ...
                    .body(new PactDslJsonBody()
                        ...
                        .stringValue("ssn", "71039012349") // Strict value
    ...
    public void getPersonAndValidateFields() throws JsonProcessingException {
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        Person person = Person.builder().name("Roger Antonsen").ssn("71039012399").build();

        RequestResponsePact pact = ConsumerPactBuilder
                .consumer("MagentoWeb").hasPactWith("User-Service")
                ...
                .willRespondWith()
                    ...
                    .body(new PactDslJsonBody()
                        ...
                        .stringValue("ssn", "71039012399") // Strict value
